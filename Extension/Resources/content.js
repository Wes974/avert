(() => {
  ...
  function showBanner(verdict) {
    if (document.getElementById("impostor-banner-host"))
      return;
    ...
    text.style.flex = "1";
    text.textContent = verdict.reason ?? "Impostor : cette page présente plusieurs caractéristiques de page de phishing. Vérifiez l'adresse avant de saisir quoi que ce soit.";
